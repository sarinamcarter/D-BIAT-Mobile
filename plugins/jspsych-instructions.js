    ...
    function show_current_page() {
      ...
      if (trial.show_clickable_nav) {
        ...
        if (current_page != 0 && trial.allow_backward) {
          nav_html += "<button id='jspsych-instructions-back' class='jspsych-btn' style='margin-right: 5px;'>"+trial.button_label_previous+"<br><br>&larr;</button>";
        }
        nav_html += "<button id='jspsych-instructions-next' class='jspsych-btn' style='margin-left: 5px;'>"+trial.button_label_next+"<br><br>&rarr;</button></div>"
