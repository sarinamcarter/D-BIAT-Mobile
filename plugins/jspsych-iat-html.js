 ...
 **/
 ...
 jsPsych.plugins['biat-html'] = (function() {
  ...
  plugin.info = {
    ...
    parameters: {
      ...
      lower_category_label: {
        ...
        array: true,
        default: ['right'],
        description: 'The label that is associated with the stimulus. Aligned below the upper category label.'
      },
      key_to_move_forward: {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    html_str += "<div style='position: absolute; height: 20%; width: 100%; margin-left: auto; margin-right: auto; top: +75px; left: 0; right: 0'>";


    html_str += "<p>Press " + trial.left_category_key + " for:<br> " +
    trial.upper_category_label[0].bold() + "<br>" + "or<br>" +
    trial.lower_category_label[0].bold() + "</p></div>";
    ...
    var after_response = function(info) {
      ...
      if(trial.stim_key_association == "E") {
      ...
      } else if(trial.stim_key_association == "I") {
